...
// current check being removed
			if(((v[LINE_PHASE_R]<1800)&&(v[LINE_PHASE_R]>960))||((v[LINE_PHASE_Y]<1800)&&(v[LINE_PHASE_Y]>960))||((v[LINE_PHASE_B]<1800)&&(v[LINE_PHASE_B]>960)))
			{
