...
typedef struct tag_class20_child_record_t
{
	...
	const season_profile_t	*p_season_profile_active;		// Season profile active 
	...
	const season_profile_t	*p_season_profile_passive;		// Season profile passive  
	...
	const day_profile_t		*p_day_profile_passive;			// Day profile passive 
