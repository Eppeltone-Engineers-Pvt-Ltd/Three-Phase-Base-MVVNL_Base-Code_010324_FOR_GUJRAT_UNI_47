...
#define _00_ADPC_DI_OFF         (0x00U) /* use P20, P21, P22, P23, P24, P25 as analog input */
#define _01_ADPC_DI_ON          (0x01U) /* use P20, P21, P22, P23, P24, P25 as digital input */
#define _02_ADPC_DI_ON          (0x02U) /* use P21, P22, P23, P24, P25 as digital input */
#define _03_ADPC_DI_ON          (0x03U) /* use P22, P23, P24, P25 as digital input */
#define _04_ADPC_DI_ON          (0x04U) /* use P23, P24, P25 as digital input */
#define _05_ADPC_DI_ON          (0x05U) /* use P24, P25 as digital input */
#define _06_ADPC_DI_ON          (0x06U) /* use P25 as digital input */
...
#define _00_PFSEG39_PORT                (0x00U) /* used the Pmn pin as port (other than segment output) */
/*
    LCD port function registers 5 (PFSEG5)
*/
/* Port (other than segment output)/segment outputs specification of Pmn pins (PFSEGxx) */
#define _00_PFSEG40_PORT                (0x00U) /* used the Pmn pin as port (other than segment output) */
#define _00_PFSEG41_PORT                (0x00U) /* used the Pmn pin as port (other than segment output) */
/*
