...
#define _03_TAU_CH5_INPUT_fIM                   (0x03U)     /* middle-speed on-chip oscillator clock (fIM) */
#define _04_TAU_CH5_INPUT_fIL                   (0x04U)     /* low-speed on-chip oscillator clock (fIL) */
#define _05_TAU_CH5_INPUT_fSUB                  (0x05U)     /* subsystem clock (fSUB) */
...
/* Selection of timer input used with channel 0 (TIS07- TIS06) */
#define _00_TAU_CH7_INPUT_TI07                  (0x00U)     /* input signal of timer input pin (TI07) */
#define _40_TAU_CH7_INPUT_RTCOUT                (0x40U)     /* output signal of RTCOUT */
#define _80_TAU_CH7_INPUT_RXD0                  (0x80U)     /* input signal of RXD0 */
#define _C0_TAU_CH7_INPUT_ELC                   (0xC0U)     /* event input signal from ELC */
...
#define _00_TAU_CH7_TI07_INPUT                  (0x00U) /* input signal of the TI07 pin as a timer input */
